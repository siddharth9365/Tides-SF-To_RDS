...
public class Scored_CallBean {
	...
	Boolean Caller_Left_Number__c;
	String Caller_Name__c;
	String Callers_Phone_Number__c;
	String Caller_User__c;
	...
	String Call_Type__c;
	Boolean Cancel_Appt__c;
	Boolean Change_Appt__c;
	...
	String General_call_details__c;
	Integer How_Many_Appts__c;
	Boolean is_call_back_before_scored__c;
	Boolean Is_latest_scored__c;
	Boolean Is_QA_Process_completed__c;
	Boolean Is_unclear_voice__c;
	Boolean is_updated_via_dashboard__c;
	Boolean Is_Update_Via_Batch_T__c;
	Boolean Left_Message__c;
	String Log__c;
	Boolean Maintained_Control__c;
	// Double Temp_Num_Maintained_Control__c;
	Boolean Medicare__c;
	Boolean Name_Twice__c;
	...
	Boolean updated_via_new_batch__c;
	Boolean VM_Request__c;
	Boolean Was_the_audio_bad__c;
	Boolean Was_This_a_new_Appointment_Opportuni__c;
	Boolean Was_This_a_new_Appointment_Opportunity__c;
	String Yes_Please_Choose_Why_They_called__c;
	...
	public Boolean getAppt_Scheduled__c() {
		return Appt_Scheduled__c;
	}

	public void setAppt_Scheduled__c(Boolean appt_Scheduled__c) {
	...
	public Boolean getCaller_left_name__c() {
		return Caller_left_name__c;
	}

	public void setCaller_left_name__c(Boolean caller_left_name__c) {
		Caller_left_name__c = caller_left_name__c;
	}

	public Boolean getCaller_Asked_Appt__c() {
		return Caller_Asked_Appt__c;
	}

	public void setCaller_Asked_Appt__c(Boolean caller_Asked_Appt__c) {
		Caller_Asked_Appt__c = caller_Asked_Appt__c;
	}

	public Boolean getCaller_Interest_In_Appt__c() {
		return Caller_Interest_In_Appt__c;
	}

	public void setCaller_Interest_In_Appt__c(Boolean caller_Interest_In_Appt__c) {
		Caller_Interest_In_Appt__c = caller_Interest_In_Appt__c;
	}

	public Boolean getCaller_Left_Number__c() {
		return Caller_Left_Number__c;
	}

	public void setCaller_Left_Number__c(Boolean caller_Left_Number__c) {
	...
	public Boolean getCancel_Appt__c() {
		return Cancel_Appt__c;
	}

	public void setCancel_Appt__c(Boolean cancel_Appt__c) {
		Cancel_Appt__c = cancel_Appt__c;
	}

	public Boolean getChange_Appt__c() {
		return Change_Appt__c;
	}

	public void setChange_Appt__c(Boolean change_Appt__c) {
	...
	public Boolean getDid_audio_Played__c() {
		return Did_audio_Played__c;
	}

	public void setDid_audio_Played__c(Boolean did_audio_Played__c) {
	...
	public Boolean getIs_call_back_before_scored__c() {
		return is_call_back_before_scored__c;
	}

	public void setIs_call_back_before_scored__c(Boolean is_call_back_before_scored__c) {
		this.is_call_back_before_scored__c = is_call_back_before_scored__c;
	}

	public Boolean getIs_latest_scored__c() {
		return Is_latest_scored__c;
	}

	public void setIs_latest_scored__c(Boolean is_latest_scored__c) {
		Is_latest_scored__c = is_latest_scored__c;
	}

	public Boolean getIs_QA_Process_completed__c() {
		return Is_QA_Process_completed__c;
	}

	public void setIs_QA_Process_completed__c(Boolean is_QA_Process_completed__c) {
		Is_QA_Process_completed__c = is_QA_Process_completed__c;
	}

	public Boolean getIs_unclear_voice__c() {
		return Is_unclear_voice__c;
	}

	public void setIs_unclear_voice__c(Boolean is_unclear_voice__c) {
		Is_unclear_voice__c = is_unclear_voice__c;
	}

	public Boolean getIs_updated_via_dashboard__c() {
		return is_updated_via_dashboard__c;
	}

	public void setIs_updated_via_dashboard__c(Boolean is_updated_via_dashboard__c) {
	...
	public Boolean getLeft_Message__c() {
		return Left_Message__c;
	}

	public void setLeft_Message__c(Boolean left_Message__c) {
	...
	public Boolean getMaintained_Control__c() {
		return Maintained_Control__c;
	}

	public void setMaintained_Control__c(Boolean maintained_Control__c) {
		Maintained_Control__c = maintained_Control__c;
	}

	public Boolean getMedicare__c() {
		return Medicare__c;
	}

	public void setMedicare__c(Boolean medicare__c) {
		Medicare__c = medicare__c;
	}

	public Boolean getName_Twice__c() {
		return Name_Twice__c;
	}

	public void setName_Twice__c(Boolean name_Twice__c) {
	...
	public Boolean getClear_and_Courteous__c() {
		return Clear_and_Courteous__c;
	}

	public void setClear_and_Courteous__c(Boolean clear_and_Courteous__c) {
		Clear_and_Courteous__c = clear_and_Courteous__c;
	}

	public Boolean getQA__c() {
		return QA__c;
	}

	public void setQA__c(Boolean qA__c) {
		QA__c = qA__c;
	}
	...
	public Boolean getSchedule_Appt__c() {
		return Schedule_Appt__c;
	}

	public void setSchedule_Appt__c(Boolean schedule_Appt__c) {
	...
	public Boolean getUpdated_via_new_batch__c() {
		return updated_via_new_batch__c;
	}

	public void setUpdated_via_new_batch__c(Boolean updated_via_new_batch__c) {
		this.updated_via_new_batch__c = updated_via_new_batch__c;
	}

	public Boolean getVM_Request__c() {
		return VM_Request__c;
	}

	public void setVM_Request__c(Boolean vM_Request__c) {
		VM_Request__c = vM_Request__c;
	}

	public Boolean getWas_the_audio_bad__c() {
		return Was_the_audio_bad__c;
	}

	public void setWas_the_audio_bad__c(Boolean was_the_audio_bad__c) {
		Was_the_audio_bad__c = was_the_audio_bad__c;
	}

	public Boolean getWas_This_a_new_Appointment_Opportuni__c() {
		return Was_This_a_new_Appointment_Opportuni__c;
	}

	public void setWas_This_a_new_Appointment_Opportuni__c(Boolean was_This_a_new_Appointment_Opportuni__c) {
		Was_This_a_new_Appointment_Opportuni__c = was_This_a_new_Appointment_Opportuni__c;
	}

	public Boolean getWas_This_a_new_Appointment_Opportunity__c() {
		return Was_This_a_new_Appointment_Opportunity__c;
	}

	public void setWas_This_a_new_Appointment_Opportunity__c(Boolean was_This_a_new_Appointment_Opportunity__c) {
